...
(function(ext) {
    ...
    var descriptor = {
        blocks: [
            ...
            ["r", "US-016 distance", "distance_US-016"],
            [" ", "US-016(A) %n", "distance2", 0],
            [" ", "3 color LED blue(D) %n PWM %n red(D) %n PWM %n green(D) %n PWM %n", "three_color_led", 5, 100, 6, 100, 9, 100],
            ["r", "potentiometer value", "value_potentiometer"],
            [" ", "potentiometer(A) %n", "potentiometer", 0],
            ["r", "sound sensor value", "value_sound_sensor"],
            [" ", "sound sensor(A) %n", "sound_sensor", 0],
            ["r", "photovaristor value", "value_photovaristor"],
            [" ", "photovaristor(A) %n", "photovaristor", 0],
            ["r", "alcohol sensor value(analog)", "alcohol_sensor_value_analog"],
            ["r", "alcohol sensor value(digital)", "alcohol_sensor_value_digital"],
            [" ", "alcohol sensor(A) %n (D) %n", "alcohol_sensor", 0, 2],
            ["r", "fire sensor value(analog)", "IR_sensor_level_analog"],
            ["r", "fire sensor value(digital)", "IR_sensor_level_digital"],
            [" ", "fire sensor(A) %n (D) %n", "IR_sensor", 0, 2],
            ["r", "Tracker Sensor value1", "Tracker_Sensor_value"],
            ["r", "Tracker Sensor value2", "Tracker_Sensor_value2"],
            ["r", "Tracker Sensor value3", "Tracker_Sensor_value3"],
            ["r", "Tracker Sensor value4", "Tracker_Sensor_value4"],
            ["r", "Tracker Sensor value5", "Tracker_Sensor_value5"],
            [" ", "Tracker Sensor1(A) %n", "Tracker_Sensor", 0],
            [" ", "Tracker Sensor2(A) %n", "Tracker_Sensor2", 0],
            [" ", "Tracker Sensor3(A) %n", "Tracker_Sensor3", 0],
            [" ", "Tracker Sensor4(A) %n", "Tracker_Sensor4", 0],
            [" ", "Tracker Sensor5(A) %n", "Tracker_Sensor5", 0],
            [" ", "forward EnA(B)(PWM)digital pin: %n In1(3)digital pin: %n In2(4)digital pin: %n speed: %n", "forward_298", "pin", 4, 7, 250],
            [" ", "backward EnA(B)(PWM)digital pin: %n In1(3)digital pin: %n In2(4)digital pin: %n speed: %n", "back_298", "pin", 4, 7, 250],
            [" ", "stop EnA(B)(PWM)digital pin: %n In1(3)digital pin: %n In2(4)digital pin: %n", "stop_298", "pin", 4, 7],
            [" ", "forward PWMA(B)digital pin: %n DIRA(B)digital pin: %n speed: %n", "back_293", 5, 4, 250],
            [" ", "backward PWMA(B)digital pin: %n DIRA(B)digital pin: %n speed: %n", "forward_293", 5, 4, 250],
            [" ", "stop PWMA(B)digital pin: %n ", "stop_293", 5],
            ["r", "tilt sensor value", "value_tilt_sensor"],
            [" ", "tilt sensor(D) %n", "tilt_sensor", 2],
            ["r", "micro switch value", "value_microswitch"],
            [" ", "micro switch(D) %n", "microswitch", 2],
            ["r", "reed sensor value", "value_reed_sensor"],
            [" ", "reed sensor(D) %n", "reed_sensor", 2],
            ["r", "joystick value1", "value_joystick1"],
            ["r", "joystick value2", "value_joystick2"],
            [" ", "joystick(A) %n (A) %n", "joystick", 0, 1],
            ["r", "rain sensor value", "value_rain_sensor"],
            [" ", "rain sensor(A) %n", "rain_sensor", 0],
            ["r", "soil sensor value", "value_soil_sensor"],
            [" ", "soil sensor(A) %n", "soil_sensor", 0],
            [" ", "relay(D) %n value: %m.value ", "relay_module", 2, 0],
            ["r", "pir value", "value_pir"],
            [" ", "passive infrared sensor(D) %n", "pir", 2]
		],
        menus: {
